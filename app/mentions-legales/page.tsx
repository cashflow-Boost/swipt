...
export const metadata: Metadata = {
  title: "Mentions légales — SWIPT",
  description: "Mentions légales du service SWIPT, standard téléphonique intelligent des artisans du dépannage.",
};
  ...
  return (
    <LegalDoc title="Mentions légales" updated="25 juillet 2026">
      <LSection n="1." title="Éditeur du site">
        <p>Le site et le service SWIPT sont édités par :</p>
      ...
      <LSection n="3." title="Propriété intellectuelle">
        <p>
          L&apos;ensemble des éléments du site (marque « SWIPT », logo, textes, interface, code) est protégé par
