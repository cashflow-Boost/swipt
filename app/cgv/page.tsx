...
export const metadata: Metadata = {
  title: "Conditions générales de vente — Rimova",
  description: "Conditions générales de vente et d'utilisation du service d'abonnement Rimova.",
};
  ...
  return (
    <LegalDoc title="Conditions générales de vente" updated="25 juillet 2026">
      <LSection n="1." title="Objet">
        <p>
          Les présentes conditions régissent l&apos;abonnement au service Rimova, un standard téléphonique
      ...
      <LSection n="3." title="Période d'essai">
        <p>
          L&apos;abonnement débute par une offre de découverte : vos <b className="text-ink">7 premiers appels traités</b> sont offerts, sans
      ...
      <LSection n="7." title="Responsabilité">
        <p>
          Rimova est un outil d&apos;assistance : la responsabilité finale des rendez-vous, devis et factures
