...
export const metadata: Metadata = {
  title: "Tarifs",
  description: "Solo 99 €, Pro 199 €, Agence 399 € par mois. Vos 7 premiers appels gérés sont offerts, sans carte bancaire.",
};
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-6xl px-6 md:px-8">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-center text-[19px] font-light leading-relaxed tracking-wide text-soft">
            Vos 7 premiers appels gérés sont offerts, sans carte bancaire. Vous choisissez votre offre seulement
            ensuite.
          </p>
          <div className="mt-16">
